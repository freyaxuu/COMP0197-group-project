# src/fx_forecasting/visualization/plots.py
...
def plot_all_series(df: pd.DataFrame, timestamp_col: str = "timestamp"):
    """
    Plot all numeric series against time.
    """
...
def plot_target_series(
    ...
    """
    Plot one target series over time.
    """
...
def plot_histogram(
    ...
    """
    Plot histogram of a chosen column.
    """
...
def plot_training_history(history, metric="loss"):
    """
    Plot training vs validation history for a selected metric.
...
def plot_predictions(
    ...
    # keep last n_points if specified
    ...
    residuals = targets_plot - preds_plot
